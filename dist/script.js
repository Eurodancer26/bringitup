...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var path = 'assets/question.php';
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('form', 'input', message, path).init();
...
function () {
  ...
  _createClass(Download, [{
    ...
    value: function init() {
      ...
      try {
        this.downloadElems.forEach(function (item) {
...
/*#__PURE__*/
function () {
  function Form(forms, inputs, message, path) {
    ...
    value: function initMask() {
      var setCursorPosition = function setCursorPosition(position, element) {
        ...
        if (element.setSelectionRange) {
          ...
          var range = element.value.createTextRange();
      ...
      try {
        ...
        if (state.data === 0) {
          if (blockedElem.querySelector('.play__circle').classList.contains('closed')) {
            ...
            if (blockedElem.getAttribute('data-disabled') == 'true') {
              blockedElem.querySelector('.play').style.cursor = 'pointer';
            }
          }
        }
      } catch (e) {}
...
function () {
  ...
  _createClass(ShowInfo, [{
    key: "init",
    value: function init() {
      this.plusBtns.forEach(function (plus) {
        plus.addEventListener('click', function () {
          var sibling = plus.closest('.module__info-show').nextElementSibling;
...
function (_Slider) {
  ...
  function MainSlider(btns, btnsPrev, btnsNext) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, btnsPrev, btnsNext));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.btnsPrev.forEach(function (prev) {
        prev.addEventListener('click', function () {
          _this2.plusSlides(-1);
        });
      });
      this.btnsNext.forEach(function (next) {
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      btnsPrev = _ref.btnsPrev,
      btnsNext = _ref.btnsNext,
      _ref$next = _ref.next,
